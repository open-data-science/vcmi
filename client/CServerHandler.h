...
public:
    ...
    virtual void sendHostGame(bool allowOnlyAI = false) const = 0;
};
...
public:
    ...
    void sendHostGame(bool allowOnlyAI = false) const override;
    ...
    void debugStartHost(std::string filename, bool save = false);
    void debugStartJoin(std::string server = "127.0.0.1", int port = 3030);
};
